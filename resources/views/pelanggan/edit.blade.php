...
@section('content')
    ...
    <div class="max-w-2xl px-6 py-8">
        ...
        <nav class="flex items-center gap-1.5 text-xs text-slate-400 dark:text-gray-500 mb-6">
            ...
            <span>/</span>
            <span class="text-slate-700 dark:text-gray-300">Edit Pelanggan</span>
        </nav>

        {{-- Header --}}
        <div class="mb-6">
            <h1 class="text-xl font-semibold text-slate-900 dark:text-white">Edit Pelanggan</h1>
            <p class="text-sm text-slate-400 dark:text-gray-400 mt-0.5">{{ $pelanggan->NamaPelanggan }}</p>
        </div>
            ...
            <form action="{{ route('pelanggan.update', $pelanggan->id) }}" method="POST">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" id="nama" name="nama_pelanggan"
                        value="{{ old('nama_pelanggan', $pelanggan->NamaPelanggan) }}" placeholder="Nama lengkap pelanggan"
                ...
                <div class="mb-5">
                    ...
                    <textarea id="alamat" name="alamat" rows="3" placeholder="Alamat lengkap"
                        class="form-textarea">{{ old('alamat', $pelanggan->Alamat) }}</textarea>
                </div>
                ...
                <div class="mb-6">
                    <label for="telepon" class="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-1.5">No
                        HP</label>
                    <input type="text" id="telepon" name="nomor_telepon"
                        value="{{ old('nomor_telepon', $pelanggan->NomorTelepon) }}" placeholder="08xx xxxx xxxx"
                        class="form-input">
                </div>
                ...
                <div class="flex items-center gap-3">
                    <button type="submit"
                        class="bg-teal-600 hover:bg-teal-700 dark:bg-aqua-500 dark:hover:bg-aqua-600 text-white text-sm font-medium px-5 py-2.5 rounded-lg transition">
                        Update
                    </button>
